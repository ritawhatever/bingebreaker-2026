...
const Celebration: React.FC<CelebrationProps> = ({ onComplete, message = "Great Job!" }) => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none flex items-center justify-center z-[100] animate-in fade-in duration-300">
      <div className="bg-white/95 p-8 rounded-3xl shadow-xl backdrop-blur-sm border-2 border-teal-50 transform scale-100 transition-all">
        <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-teal-700 text-center">
            ✨ {message} ✨
        </div>
      </div>
    </div>
